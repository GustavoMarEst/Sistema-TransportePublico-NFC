...
public class Registro extends AppCompatActivity {
    ...
    Button mBtn_crear;
    EditText mUsuario, mCorreo, mContraseña, mApellido, mConfirmarContraseña;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApellido = findViewById(R.id.txtr_apellidos);
        mCorreo = findViewById(R.id.txtr_correo);
        mContraseña = findViewById(R.id.txtr_contraseña);
        mConfirmarContraseña = findViewById(R.id.txtr_confContraseña);
        mBtn_crear = findViewById(R.id.btnr_regresar);
    ...
    private void insertarDatos(){
        ...
        final String confContra = mConfirmarContraseña.getText().toString().trim();

        if(nombre.isEmpty()) {
            mUsuario.setError("Introduce tu nombre");
            return;
        }else if (apellido.isEmpty()){
            mApellido.setError("Introduce tus apellidos");
            return;
            ...
            mConfirmarContraseña.setError("Confirma tu contraseña");
            return;
        }else if(!contraseña.equals(confContra)){
            mConfirmarContraseña.setError("Las contraseñas no coinciden");
            return;
        }
        else{
            StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.1.68:8080/tesis_/register.php", new Response.Listener<String>() {
                @Override
